 ...
 const isMatch= useMediaQuery(theme.breakpoints.down("md")); /* returns true or false if the screens size is below md(900px) or not */
  ...
  return (
    <div className='navbar' style={{marginBottom:"10px"}}>
      <AppBar elevation={5} sx={{backgroundColor:"white",height:"98px"}} position="fixed"> 
            <Toolbar>
                <Box sx={{display:"flex", justifyContent:"space-between", marginTop:"20px", width:"100%", alignItems:"center"}}component="div">
                    {/*Logo*/}
                    <Box >
                        <img src={pic} alt="logo" width="200" height="50" />
